...
namespace ChatBoxScrollbar
{
    public partial class ChatBoxScrollbar : UserControl
    {
        ...
        private void UpdateRegisteredHandlesScroll()
        {
            ...
            {
                SetScrollingInfo(handle, Orientation.Vertical, ThumbPosition);
            }
        }
